...
def second_level_permutation_test(contrasts, imgs, n_perm=50,
    ...
    cluster size, as a second level analysis.

    Parameters
    ----------
    contrasts: list of string,
        The string corresponds to the contrast name.
        Contrasts must correspond to a symmetric comparison of conditions.

    imgs: list of (Niimg-like object or list of Niimg-like objects),
        See http://nilearn.github.io/building_blocks/manipulating_mr_images.html#niimg.
        Every element of the list must have the same length. So the same
        number of contrasts, each of them corresponding to one subject.
    ...
    contrast_results = {}
    for (con_id, con_name) in enumerate(contrasts):
        ...
        contrast_results[con_name] = (unc_pvals,
                                    cor_pvals)
