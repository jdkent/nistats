    ...
    def fit(self, run_imgs, events=None, regressors=None,
        ...
        if design_matrices is None:
            ...
            design_matrices = _check_run_tables(run_imgs, design_matrices,
                                                'design_matrices')
        # check the number of events and regressor files match number of runs
        # Also check events and regressor files can be loaded as DataFrame
        ...
        for run_idx, run_img in enumerate(run_imgs):
            ...
            if self.verbose > 1:
                t_glm = time.time()
                print 'Starting GLM computation'
